                ...
                methods: {
                        calcPercentage() {
                                ...
                                for (let i = 0; i < this.courses.length; i++) {
                                        sum += this.courses[i][1]
                                }
                                return Math.round((sum / 180) * 10) * 10;
                        }
                }
        }
</script>
...
<template>
        ...
        <div class="2xl:flex 2xl:flex-row justify-center mt-12">
                <img src="/tum.jpg" class="w-96 h-96 m-16 2xl:my-auto max-2xl:mx-auto justify-center items-center rounded-3xl bg-cover shadow-xl shadow-black/30 border-y border-b-white/10 border-t-white/15 transition-transform hover:scale-110"></img>
