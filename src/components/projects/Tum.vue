        ...
        <div class="2xl:flex 2xl:flex-row justify-center my-12 lg:m-12">
                ...
                <div class="my-auto">
                        <p
                                ...
                                Since the Wintersemester of 22/23, I've been studying Computersciene at TUM
                                simultaniously to school thanks to Schueler.In.TUM. I took many different courses during
                                the last semesters, e.g. EidI (2.3), PGdP (2.7) or ERA (1.7).
                                <br> <br>
